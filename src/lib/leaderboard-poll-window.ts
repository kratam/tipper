// A leaderboard-polling csak akkor fut, ha épp meccs-ablakban vagyunk: kickoff
// előtt 10 perctől a kezdés után 3 óráig (meccs + lezárás/scoring). Ezen kívül a
// tabella úgyse változik, így nem kérdezzük a DB-t — ezért a Neon compute el tud
// aludni (scale-to-zero). Lásd: use-leaderboard-polling.ts.
